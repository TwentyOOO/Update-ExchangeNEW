...
.method private generateGroupSaleMessage(Ljava/lang/String;Ljava/util/List;DD)Ljava/lang/String;
    ...
    if-eqz p5, :cond_array_null_1
    array-length v2, p5
    if-ge p3, v2, :cond_array_bounds_1
    if-ltz p3, :cond_array_bounds_1
    
    aget-wide v0, p5, p3
    goto :goto_array_safe_1
    
    :cond_array_null_1
    :cond_array_bounds_1
    # Use default value if array access is unsafe
    const-wide v0, 0x0
...
.method private synthetic lambda$checkForUpdate$32()V
    ...
    if-eqz v3, :cond_stream_close
    invoke-virtual {v3}, Ljava/io/InputStream;->close()V
    :cond_stream_close
    goto :goto_stream_done
    
    :catchall_0
    # Ensure InputStream is closed even if exception occurs
    if-eqz v3, :cond_stream_error
    invoke-virtual {v3}, Ljava/io/InputStream;->close()V
    :cond_stream_error
    throw v0
